...
variable "vpc_app_subnets" {
  description = "List of application subnet CIDR ranges"
  type        = list(string)
...
variable "vpc_tags" {
  ...
  type        = map(string)
  default     = { "Name" = "asgn-vpc", "created-by" = "terraform" }
}
...
variable "asg_sg_tags" {
  ...
  type        = map(string)
  default     = { "Name" = "asgn-asg-sg", "created-by" = "terraform" }
}
...
variable "asg_iam_role_tags" {
  ...
  type        = map(string)
  default     = { "Name" = "asgn-asg-iam-role", "created-by" = "terraform" }
}
...
variable "asg_instance_tags" {
  ...
  type        = map(string)
  default     = { "Name" = "asgn-asg-instance", "created-by" = "terraform" }
}

variable "asg_volume_tags" {
  description = "Auto scaling group volume tags"
  type        = map(string)
  default     = { "Name" = "asgn-asg-volume", "created-by" = "terraform" }
}

variable "asg_tags" {
  description = "Auto scaling group tags"
  type        = map(string)
  default     = { "Name" = "asgn-asg", "created-by" = "terraform" }
}
...
variable "alb_sg_tags" {
  ...
  type        = map(string)
  default     = { "Name" = "asgn-alb-sg", "created-by" = "terraform" }
}
...
variable "alb_tags" {
  ...
  type        = map(string)
  default     = { "Name" = "asgn-alb", "created-by" = "terraform" }
}
...
variable "rds_sg_tags" {
  ...
  type        = map(string)
  default     = { "Name" = "asgn-rds-sg", "created-by" = "terraform" }
}
...
variable "rds_tags" {
  ...
  type        = map(string)
  default     = { "Name" = "asgn-rds", "created-by" = "terraform" }
}
